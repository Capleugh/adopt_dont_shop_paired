...
RSpec.describe "As a visitor" do
  describe "when I visit a shelter's show page" do
    ...
    it "next to each review, I will see a button to delete that review and when I click that button, I am redirected to the shelter's show page where I no longer see that review" do
